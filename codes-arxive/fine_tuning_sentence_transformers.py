...
df0 = pd.read_csv("/content/ChemAP/dataset/DrugApp/All_training_feature_vectors.csv")
df=df0[["SMILES",	"Label"]]
...
model = SentenceTransformer("DeepChem/ChemBERTa-77m-MTR" , cache_folder="/content/new") # "Muennighoff/SGPT-125M-weightedmean-nli-bitfit" "microsoft/mpnet-base"
...
args = SentenceTransformerTrainingArguments(
    ...
    run_name ="fine tuning chemberta double smiles labeled with sbert." ,
    seed = 42 ,
    data_seed = 42,
    do_eval=True,
    do_train=True,
