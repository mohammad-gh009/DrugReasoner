...
train_df , val_df , test_df , dataset_train , dataset_df , dataset_test = train_valid_test_split("/home/u111169/wrkdir/mgh-project/the_drugbank_daatset_to_replace_with_chemap_for_test.csv")
...
def get_most_app_and_most_nonapp(index , dataset , number_of_simmilar_in_each):
    """
    
    """
    
    if dataset== "val": 
        smile_for_test = dataset_df["SMILES"][index]
        labels_for_test= dataset_df["labels"][index]   
        ...
        smile_for_test = dataset_test["SMILES"][index]
        labels_for_test= dataset_test["labels"][index]   
        most_app , most_nonapp , tot = get_sim_score(dataset_train,smile_for_test, number_of_simmilar_in_each , number_of_simmilar_in_each) 

        return most_app , most_nonapp , tot    
    
    elif dataset== "train": 
        smile_for_test = dataset_train["SMILES"][index]
        labels_for_test= dataset_train["labels"][index] 
