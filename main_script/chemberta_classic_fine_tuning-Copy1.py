...
train_df = df2noncanonical(train_df)
val_df = df2noncanonical(val_df)
...
training_args = TrainingArguments(
    output_dir='/home/u111169/wrkdir/mgh-project/checkpoints/fine_tuning_chemberta_classic_way_noncanonical',
    num_train_epochs= 15,
    ...
    do_train=True,
    weight_decay=0.1,
    logging_dir = '/home/u111169/wrkdir/mgh-project/checkpoints/fine_tuning_chemberta_classic_way_noncanonical/logs',
